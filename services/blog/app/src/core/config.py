...
class JWTSettings(BaseSettings):
    ...
    secret_key: str = Field(
        ...
        default='fbZcSJTeVr7jGghigP1IC8VR9Pkv93hMQwcLqsP1WnurwQpQZqsL5GwO056j2fnV2vT6uVJwJYFAvhLnkyNSb8',
    )
...
class Settings(BaseSettings):
    project_name: str = Field(alias="PROJECT_NAME", default="AledevBlog")
    project_description: str = Field(
        alias="PROJECT_DESCRIPTION", default="Educational blog and knowledge base for programming in the ALEDEV platform"
    )
